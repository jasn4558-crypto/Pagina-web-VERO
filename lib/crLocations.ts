 ...
 */
export const CR_LOCATIONS: Record<string, Record<string, string[]>> = {
  "San José": {
    "San José": [
    ...
    "Puriscal": [
      ...
      "San Rafael", "Candelarita", "Desamparaditos", "San Antonio",
      "Chires"
    ],
    ...
    "Pérez Zeledón": [
      ...
      "San Pedro", "Platanares", "Pejibaye", "Cajón", "Baru", "Río Nuevo",
      "Páramo", "La Amistad"
    ],
  ...
  "Alajuela": {
    ...
    "San Ramón": [
      ...
      "San Rafael", "San Isidro", "Ángeles", "Alfaro", "Volio",
      "Concepción", "Zapotal", "Peñas Blancas", "San Lorenzo"
    ],
    "Grecia": [
      "Grecia", "San Isidro", "San José", "San Roque", "Tacares",
      "Puente de Piedra", "Bolivar"
    ],
    ...
    "Poás": ["San Juan", "San Pedro", "San Juan", "Carrillos", "Sabana Redonda"],
    "Orotina": ["Orotina", "El Mastate", "Hacienda Vieja", "Coyolar", "La Ceiba"],
    "San Carlos": [
      "Quesada", "Florencia", "Buenavista", "Aguas Zarcas", "Venecia",
      "Pital", "La Fortuna", "La Tigra", "La Palmera", "Venado",
      "Cutris", "Monterrey", "Pocosol"
    ],
  ...
  "Puntarenas": {
    "Puntarenas": [
      ...
      "Isla del Coco", "Cóbano", "Chacarita", "Chira",
      "Acapulco", "El Roble", "Arancibia"
    ],
    "Esparza": ["Espíritu Santo", "San Juan Grande", "Macacona", "San Rafael", "San Jerónimo", "La Pitahaya"],
    "Buenos Aires": [
  ...
  "Limón": {
    ...
    "Pococí": [
      "Guápiles", "Jiménez", "La Rita", "Roxana", "Cariari",
      "Colorado", "La Colonia"
    ],
